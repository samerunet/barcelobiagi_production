  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { label_ru: 'Размерная сетка', label_en: 'Size Guide', path: '/size-guide' },
      ],
    },
    {
      title_ru: 'Компания',
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                <MapPin size={18} className="text-accent-camel flex-shrink-0 mt-0.5" />
                <div className="text-white/60 leading-relaxed">
                  <p>{t('ТРЦ «Сереряный город»', 'Serebryany Gorod Mall')}</p>
                  <p>{t('г. Иваново, ул. 8 Марта, 32', 'Ivanovo, 8 Marta St., 32')}</p>
                </div>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-center gap-3">
                <Instagram size={18} className="text-accent-camel flex-shrink-0" />
                <a 
              ...
              <li className="flex items-center gap-3">
                <Facebook size={18} className="text-accent-camel flex-shrink-0" />
                <a 
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="text-white/40 text-xs space-y-2">
            <p>© 2025 Barcelo Biagi Ivanovo. {t('Все права защищены.', 'All rights reserved.')}</p>
